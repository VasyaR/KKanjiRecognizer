from KKanjiRecognizerPackage.recognize_kanji import recognize_kanji
import os

def test_known_black_background():
    # Test a known image with black background
    image_path = "KKanjiRecognizerPackage/PackageData/言_black_background_known.png"
    assert recognize_kanji(image_path) == "言"

def test_known_white_background():
    # Test a known image with white background
    image_path = "KKanjiRecognizerPackage/PackageData/言_white_background_known.png"
...
def test_unknown_black_background():
    ...
    image_path = "KKanjiRecognizerPackage/PackageData/与_black_background_unkown.png"
...
def test_unknown_white_background():
    ...
    image_path = "KKanjiRecognizerPackage/PackageData/与_white_background_unkown.png"
    assert recognize_kanji(image_path, black_background=False) == "Can't recognize kanji"

def test_sanity_check():
    # Test the sanity check
    image_path = "KKanjiRecognizerPackage/PackageData/Naruto_sanity_check.png"
    assert recognize_kanji(image_path) == "Can't recognize kanji"

def test_unsupported_file_type():
    # Test an unsupported file type
    image_path = "KKanjiRecognizerPackage/PackageData/unsupported_file_type.txt"
